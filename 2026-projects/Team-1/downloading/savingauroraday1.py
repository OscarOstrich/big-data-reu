...
#pred.to_netcdf("/umbc/rs/cybertrn/reu2026/team1/research/testing/Addy_testing/tc24predictions.nc")
    ...
    dir = Path("/umbc/rs/cybertrn/reu2026/team1/research/testing/Addy_testing/CamsYearRedo/threedayyear/OneDayPred")
    dir.mkdir(parents=True, exist_ok=True)


    with torch.inference_mode():
#        for step, pred in enumerate(rollout(model, batch, steps=2)):
        for pred in rollout(model, batch, steps=2):
            pred = pred.to("cpu")
